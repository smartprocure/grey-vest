...
The theme object is the source of truth for colors, fonts, spacing values, and any other styling data needed by GreyVest. It is exported from GreyVest as `theme`.
