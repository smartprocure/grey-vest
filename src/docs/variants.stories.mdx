...
| Button | `primary`, `secondary`, `danger`, `ghost` | background and text colors |
| Button | `compact`, `large` | padding, text size, and icon size |
