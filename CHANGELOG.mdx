...
* Other new components: **Dropdown** (a zero-padding variant of Popover intended to be used with DropdownItem), **Tooltip**, **Banner**, **Pager**, **TableFooter**, **Divider**, **FormField**, **Form**, and **IconButton**
* Changes to **Button**:
...
* Changes to **CheckboxList** and **RadioList**:
  ...
  * Both components now also support SpacedList props (`gap`, `columnCount`, `columnWidth`, and `columnGap`)
...
* New props on **SpacedList**: `gap`, `columnCount`, `columnWidth`, and `columnGap` (SpacedList now supports CSS columns!)
...
* Changes to **Tabs**/**TabList**:
  * 🚨 **TabList** component has been renamed to **TabsList** (plural "tabs") for parity with the `TabsList` component prop on Tabs
  * New component-level variants: **Tabs.Transparent** and **Tabs.Classic** (corresponding to **Tabslist.Transparent** and **TabsList.Classic**)
...
| Flex       | `gap`                                              | new in 3.0         |
| SpacedList | `gap`, `columnGap`                                 | new in 3.0         |
